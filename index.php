...
// 2. Amharic Translations Array (ትክክለኛ የአማርኛ ትርጉም)
$text_am = array(
...
<!-- Navigation Bar (Upgraded with Centered Menu, Language Switcher & Right-Aligned Button) -->
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm py-3 sticky-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <!-- Far Right: Language Selector Button (Saves massive space) -->
            <div class="me-3">
...
<footer class="footer-custom py-4 mt-auto">
    <div class="container text-center">
        <p class="mb-1 fw-semibold"><?php echo $lang['footer_text']; ?> &copy; 2026</p>
